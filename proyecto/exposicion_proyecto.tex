...
\begin{frame}{Soluci\'on trans\'onica de referencia}
  \begin{columns}[c]
    ...
    \column{0.40\textwidth}
      \begin{itemize}
        \item La curva cruza suavemente el punto s\'onico $(r_c,v_c)$.
        \item A la izquierda del cruce la rama es subs\'onica.
        \item A la derecha aparece la aceleraci\'on supers\'onica que caracteriza al viento solar.
        \item Esta es la referencia contra la que se validan Euler y RK4.
      \end{itemize}
  \end{columns}
\end{frame}
...
\begin{frame}{Comparaci\'on visual: Euler vs RK4}
  \begin{columns}[c]
    ...
    \column{0.38\textwidth}
      \begin{itemize}
        \item RK4 sigue casi exactamente la referencia anal\'itica.
        \item Euler reproduce la tendencia global, pero acumula error con m\'as rapidez.
        \item La figura muestra por qu\'e un m\'etodo de mayor orden compensa su mayor costo por paso.
      \end{itemize}
  \end{columns}
\end{frame}
...
\begin{frame}{Sensibilidad a la temperatura: perfiles}
  \begin{columns}[c]
    ...
    \column{0.36\textwidth}
      \begin{itemize}
        \item La velocidad aumenta con la temperatura coronal.
        \item La densidad cae de forma distinta porque la aceleraci\'on cambia en cada caso.
        \item El desplazamiento del punto s\'onico resume el cambio de r\'egimen del flujo.
      \end{itemize}
  \end{columns}
\end{frame}
...
\begin{frame}{Flujo de masa y calentamiento}
  \begin{columns}[c]
    ...
    \column{0.36\textwidth}
      \begin{itemize}
        \item Cambiar $\dot{M}$ modifica la densidad, no la forma de $v(r)$.
        \item Un t\'ermino extra de calentamiento aumenta la velocidad terminal.
        \item La figura separa con claridad el papel de continuidad y el de la ecuaci\'on de momento.
      \end{itemize}
  \end{columns}
\end{frame}
